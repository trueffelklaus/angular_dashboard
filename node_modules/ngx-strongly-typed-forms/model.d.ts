...
export declare type ValidatorFn<T> = NgValidatorFN | TypedValidatorFn<T>;
export declare type AsyncValidatorFn<T> = NgAsyncValidatorFn | TypedAsyncValidatorFn<T>;
export declare type Controls<T> = {
    [P in keyof T]: AbstractControl<T[P]>;
};
export declare type FormState<T> = T | {
    value: T;
    disabled: boolean;
};
export declare type StateAndValidators<T> = [FormState<T>] | [FormState<T>, ValidatorFn<T> | ValidatorFn<T>[]] | [FormState<T>, ValidatorFn<T> | ValidatorFn<T>[] | null, AsyncValidatorFn<T> | AsyncValidatorFn<T>[] | null];
export declare type ControlConfig<T> = FormState<T> | StateAndValidators<T> | AbstractControl<T>;
export declare type ControlsConfig<T> = ControlConfig<T> | {
...
export declare class FormBuilder {
    ...
    control<T>(value: FormState<T>, validator?: ValidatorFn<T> | ValidatorFn<T>[] | null, asyncValidator?: AsyncValidatorFn<T> | AsyncValidatorFn<T>[] | null): FormControl<T>;
    array<T>(controlsConfig: ControlConfig<T>[], validator?: ValidatorFn<T> | null, asyncValidator?: AsyncValidatorFn<T> | null): FormArray<T>;
}
